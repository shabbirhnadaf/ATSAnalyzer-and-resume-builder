...
exports.scoreResumeAgainstJD = void 0;
...
const scoreResumeAgainstJD = (resumeText, jobDescription) => {
    ...
    if (!/experiance|work experience/.test(lowerResume))
        warnings.push('Missing clear Experiance section');
    if (!/education/.test(lowerResume))
        warnings.push('Missing clear Education section');
    if (!/skills/.test(lowerResume))
        warnings.push('Missing clear Skills section');
    if (resumeText.length < 500)
        warnings.push('Resume content looks too short for strong ATS relevance');
...
exports.scoreResumeAgainstJD = scoreResumeAgainstJD;
